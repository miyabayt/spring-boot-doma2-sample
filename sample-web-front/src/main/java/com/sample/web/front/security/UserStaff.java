...
@Setter
@Getter
public class UserStaff extends org.springframework.security.core.userdetails.User {
     ...
     * @param authorities
     */
    public UserStaff(User user, Collection<? extends GrantedAuthority> authorities) {
