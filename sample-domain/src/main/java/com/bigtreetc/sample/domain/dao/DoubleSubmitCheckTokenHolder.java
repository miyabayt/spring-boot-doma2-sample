...
public class DoubleSubmitCheckTokenHolder {
  ...
  private static final ThreadLocal<String> EXPECTED_TOKEN = new InheritableThreadLocal<>();

  private static final ThreadLocal<String> ACTUAL_TOKEN = new InheritableThreadLocal<>();
